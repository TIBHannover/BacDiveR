...
mismatch <- c("Japan", "Europe")

inconsistent_data <- retrieve_search_results(
  paste0(
    "https://bacdive.dsmz.de/advsearch?advsearch=search&site=advsearch&searchparams[20][contenttype]=text&searchparams[20][typecontent]=contains&searchparams[20][searchterm]=",
    mismatch[1],
    "&searchparams[17][searchterm]=",
    mismatch[2]
  )
)
```
