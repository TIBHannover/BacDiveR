warn_slow_download <- function(N_datasets) {
  warning(
    paste0(
      N_datasets,
      " BacDive datasets are being downloaded... Please note: Depending on your internet connection speed, and the BacDive server load right now, this might take some time and may cause R(Studio) to be unresponsive intermittedly. Maybe go for a walk for a few (I'm guessing: ",
